package com.it.stock.security.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.gson.Gson;
import com.it.stock.pojo.SysUser;
import com.it.stock.utils.JwtTokenUtil;
...
public class JwtLoginAuthenticationFilter  extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        ...
        String rkeyValue = (String) redisTemplate.opsForValue().get("ck:"+rkey);
        if (rkeyValue==null || !rkeyValue.equals(checkCode)) {
            throw new RuntimeException("验证码错误");
        }
        //删除验证码
        redisTemplate.delete("ck:"+rkey);
        //生成认证token
